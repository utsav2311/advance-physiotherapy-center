...
export const LogoMarquee = memo(function LogoMarquee({
  ...
  return (
    <div
      className={cn(
        "max-w-7xl mx-auto overflow-hidden py-3 mask-[linear-gradient(to_right,transparent,black_15%,black_85%,transparent)]",
        className,
      )}
    >
      <InfiniteSlider gap={24} reverse duration={35} durationOnHover={70}>
