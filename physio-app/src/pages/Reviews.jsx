  ...
  return (
    <>
      <Seo
        ...
        description={`Rated ${ratingSummary.score}/5 on Google based on ${ratingSummary.reviewCountLabel} — real patient reviews and experiences from Advance Physiotherapy Centre, Muzaffarpur.`}
        path="/reviews"
      />
