export const doctorAchievements = [
  {
    id: 'abdm-digital-health',
    title: 'National Health Authority (ABDM) Certified',
    authority: 'Ayushman Bharat Digital Mission, Govt. of India',
  ...
  {
    id: 'gapt-membership',
    title: 'Global Association for Physiotherapy (G.A.P.T.)',
    authority: 'International Physiotherapy Organization (Public Trust Act 579)',
  ...
  {
    id: 'dr-dude-pocket-hospital',
    title: 'Clinical Insights & Team Mentorship Award',
    authority: 'Dr. Dude Pocket Hospital (Dr. Dude Private Limited)',
